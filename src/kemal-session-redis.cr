...
class Session
  class RedisEngine < Engine
    class StorageInstance
      ...
      define_storage({int: Int32, bigint: Int64, string: String, float: Float64, bool: Bool, object: StorableObjects})
    end
    ...
    define_delegators({int: Int32, bigint: Int64, string: String, float: Float64, bool: Bool, object: StorableObjects})
  end
end
